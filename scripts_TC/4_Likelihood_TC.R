...
fm0 <- glm(Survived ~ 0, family = "binomial", data = titanic)
...
model.sel(fm3, fm4, fm5, fm6, fm7, fm8, fm9, fm10, fm11)
...
pois <- fitdist(dat.test, "pois")
nbinom <- fitdist(dat.test, "nbinom")
...
source("C:/Users/piedm/Dropbox/R/GitandR/2021_master/scripts/4_dataSimulation.R") # this runs the code in the 'data_sim.R' file;
